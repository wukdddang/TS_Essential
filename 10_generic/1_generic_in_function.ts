...
// Generic이 123으로 유추된다. (const를 사용해서)
const genericResult2 = genericWhatValue("123");
// Generic이 string으로 유추된다. (let을 사용해서)
let letGenericResult = genericWhatValue("123");
...
const multipleGenericResult2 = multipleGenerics(1, true, "123");
